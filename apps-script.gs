/**
 * TruAido onboarding — Google Apps Script endpoint.
 *
 ...
 *     for. It writes the header row and — this is the part that matters —
 ...
 *     last deployed version, not the saved one — an edit alone changes nothing.
 * ---------------------------------------------------------------------------
 */
